...
#cd /overflow/tengfei/user/tengfei/projects/UKB_PSC_CommonAtlas/OtherModality/plot_and_QC;module load python/3.7.9;python3
import numpy as np
...
num_points = 100
fa_values_file = 'Heritability_beforereg_v2_hsq1.csv'
fa_values = np.loadtxt(fa_values_file,delimiter=',')
#fa_values_file1 = 'reprod.csv';fa_values1 = np.loadtxt(fa_values_file1,delimiter=',')
...
#fig.write_html('ICC_subcort_qc.html')##use this
#fig.write_html('ICC_subcort.html')
fig.write_html('Herit.html')
